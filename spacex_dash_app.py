...
def get_pie_chart(entered_site):
    if entered_site == 'ALL':
        ...
        names='Launch Site', 
        title='Successful Launches for Selected Sites')
        return fig
    else:
        df = spacex_df[spacex_df['Launch Site']==entered_site]
        df_grouped=df.groupby(['Launch Site','class']).size().reset_index(name='class count')
        fig = px.pie(df_grouped, values='class count', 
        names='class', 
        title='Successful Launches for Selected Sites')
        return fig
